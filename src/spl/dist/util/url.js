...
exports.walletUrl = exports.urlTls = exports.url = exports.CLUSTER_DEVNET = exports.cluster = void 0;
...
exports.CLUSTER_DEVNET = 'devnet';
// [CLUSTER_DEVNET]: () => clusterApiUrl(CLUSTER_DEVNET),
exports.url = process.env.RPC_URL ||
    (process.env.LIVE ? (0, web3_js_1.clusterApiUrl)(exports.cluster, false) : (0, web3_js_1.clusterApiUrl)(exports.CLUSTER_DEVNET)); // 'http://localhost:8899');
exports.urlTls = process.env.RPC_URL ||
    (process.env.LIVE ? (0, web3_js_1.clusterApiUrl)(exports.cluster, true) : (0, web3_js_1.clusterApiUrl)(exports.CLUSTER_DEVNET)); //'http://localhost:8899');
